...
faci_id serial,
	...
	constraint fk_faci_cagro_id foreign key(faci_cagro_id)references master.category_group(cagro_id) on delete cascade on update cascade,
...
faph_id serial,
	...
	constraint fk_user_faci_id foreign key (faph_user_id)references users.users(user_id) on delete cascade on update cascade
...
hore_id serial,
	...
	constraint fk_hore_user_id foreign key (hore_user_id)references users.users(user_id) on delete cascade on update cascade,
